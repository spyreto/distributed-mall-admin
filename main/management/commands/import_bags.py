...
class Command(BaseCommand):
    help = "Import bags in Distributed Mall"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Importing bags products")
        ...
        for row in reader:
            ...
            try:
                ...
                product, created = models.Bag.objects.get_or_create(
                    name=row["name"],
