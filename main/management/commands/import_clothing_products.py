...
class Command(BaseCommand):
    help = "Import clothing products in Distributed Mall"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Importing clothing products")
        ...
        for row in reader:
            ...
            try:
                ...
                product, created = models.ClothingProduct.objects.get_or_create(
                    name=row["name"],
        ...
        self.stdout.write(
            "Clothing products processed=%d (created=%d)"
