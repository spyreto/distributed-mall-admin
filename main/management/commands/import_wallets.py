...
class Command(BaseCommand):
    help = "Import wallets in Distributed Mall"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Importing wallets")
        ...
        for row in reader:
            ...
            try:
                ...
                product, created = models.Wallet.objects.get_or_create(
                    name=row["name"],
                    ...
                    color = row["color"],
                    type = row["type"],
                    type_of_closing = row["type of closing"],
                )
