...
class Command(BaseCommand):
    help = "Import watches in Distributed Mall"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Importing watches")
        ...
        for row in reader:
            ...
            try:
                ...
                product, created = models.Watch.objects.get_or_create(
                    name=row["name"],
                    ...
                    band_material = row["band material"],
                    band_color= row["band color"],
                    face_color= row["face color"],
                    water_resistance = row["water resistance"],
                )
